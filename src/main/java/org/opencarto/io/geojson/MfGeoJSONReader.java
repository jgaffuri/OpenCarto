...
public class MfGeoJSONReader {
	...
	private static Coordinate[] decodeCoordinates(JSONArray coordinates) throws JSONException {
	...
	private static Coordinate decodeCoordinate(JSONArray coord) throws JSONException {
		if (coord.length() > 2) {
