...
public class DependentLocalityType {
    ...
    protected List<DependentLocalityType.DependentLocalityName> dependentLocalityNames;
    ...
    /**
     * Gets the value of the dependentLocalityNames property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the dependentLocalityNames property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDependentLocalityNames().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DependentLocalityType.DependentLocalityName> getDependentLocalityNames() {
        if (dependentLocalityNames == null) {
            dependentLocalityNames = new ArrayList<DependentLocalityType.DependentLocalityName>();
        }
        return this.dependentLocalityNames;
    }
