 ...
 * generated in the org.opencarto.kml.xml22 package. 
...
public class ObjectFactory {
    ...
    private final static QName _scaleliteral_QNAME = new QName("http://www.opengis.net/kml/2.2", "scale");
    ...
    private final static QName _snippetliteral_QNAME = new QName("http://www.opengis.net/kml/2.2", "snippet");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.opencarto.kml.xml22
     * 
     */
    ...
    public JAXBElement<Double> createscaleliteral(Double value) {
        return new JAXBElement<Double>(_scaleliteral_QNAME, Double.class, null, value);
    }
     ...
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/kml/2.2", name = "snippet")
    public JAXBElement<String> createsnippetliteral(String value) {
        return new JAXBElement<String>(_snippetliteral_QNAME, String.class, null, value);
    }
