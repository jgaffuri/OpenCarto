...
public class Create {
    ...
    protected List<JAXBElement<? extends AbstractContainerType>> abstractContainerGroups;

    /**
     * Gets the value of the abstractContainerGroups property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abstractContainerGroups property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbstractContainerGroups().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<? extends AbstractContainerType>> getAbstractContainerGroups() {
        if (abstractContainerGroups == null) {
            abstractContainerGroups = new ArrayList<JAXBElement<? extends AbstractContainerType>>();
        }
        return this.abstractContainerGroups;
    }
