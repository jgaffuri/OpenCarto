...
public class MainParis {
	...
	public static void jardin(String inPath, String outPath, ZoomExtend zs) {
		...
		SHPProcesses.perform(inPath+"jardinWMClean_.shp", null, outPath+"jardin/", zs, new DefaultGeneralisation(), db );
	}

	public static void arbre(String inPath, String outPath, ZoomExtend zs) {
		SHPProcesses.perform(inPath+"arbresWMClean.shp", null, outPath+"arbre/", zs, new NoGeneralisation(), new DefaultDescriptionBuilder());
	}

	public static void bati(String inPath, String outPath, ZoomExtend zs) {
		SHPProcesses.perform(inPath+"volumesbatisWMClean.shp", null, outPath+"bati/", zs, new DefaultGeneralisation(), new DefaultDescriptionBuilder());
	}
