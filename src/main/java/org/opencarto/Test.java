...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		//SHPProcesses.perform(shpPath, new String[]{"INSEE_COM","NOM_COM"}, outPath, new ZoomExtend(2,5), new NoGeneralisation(), null, true, null);
		...
		//SHPProcesses.perform(shpPath, new String[]{"EU_FLAG","STAT_LEVL_"}, outPath, new ZoomExtend(2,5), new NoGeneralisation(), null, true, null);
