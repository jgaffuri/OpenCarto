...
do
	...
	wget -O orm_$usage.osm "http://overpass-api.de/api/map?data=[out:xml];(area['ISO3166-1:alpha2'='BE'][admin_level=2];)->.a;(node[railway][usage=$usage](area.a);way[railway][usage=$usage](area.a);relation[railway][usage=$usage](area.a););(._;>;);out;"
...
wget -O orm_other.osm "http://overpass-api.de/api/map?data=[out:xml];(area['ISO3166-1:alpha2'='BE'][admin_level=2];)->.a;(node[railway][!usage](area.a);way[railway][!usage](area.a);relation[railway][!usage](area.a););(._;>;);out;"
...
wget -O orm.csv "http://overpass-api.de/api/map?data=[out:csv(::id,name,description,railway,gauge,usage,'railway:traffic_mode',service,'railway:track_class',maxspeed,direction,highspeed,historic,bridge,'bridge:name',tunnel,'tunnel:name',electrified,'electrified:rail',voltage,incline,ele,start_date,end_date,operator,::timestamp,::version,::user,::user,::uid)];(area['ISO3166-1:alpha2'='BE'][admin_level=2];)->.a;(node[railway][usage](area.a);way[railway][usage](area.a);relation[railway][usage](area.a););(._;>;);out;"




#wget -O orm.osm "http://overpass-api.de/api/map?data=[out:xml];(area['ISO3166-1:alpha2'='BE'][admin_level=2];)->.a;(node[railway][usage](area.a);way[railway][usage](area.a);relation[railway][usage](area.a););(._;>;);out;"
#ogr2ogr --config OSM_USE_CUSTOM_INDEXING NO -skipfailures -f "ESRI Shapefile" shp orm.osm  -overwrite

#area['ISO3166-1:alpha2'='BE'][admin_level=2];
#area['ISO3166-1:alpha2'='BE'][admin_level=2];
#wget -O orm.osm "http://overpass-api.de/api/map?data=[out:xml];(area['ISO3166-1:alpha2'='BE'][admin_level=2];)->.a;(node[railway][usage=main](area.a);way[railway][usage=main](area.a);relation[railway][usage=main](area.a););(._;>;);out;"
