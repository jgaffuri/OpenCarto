...
wget -O orm.csv "http://overpass-api.de/api/map?data=[out:csv(::id,name,description,railway)];(node[railway][usage=main](46,8,47,9);way[railway][usage=main](46,8,47,9);relation[railway][usage=main](46,8,47,9););(._;>;);out;"
#::id,name,description,railway,::gauge,usage,"railway:traffic_mode",service,"railway:track_class",maxspeed,direction,highspeed,historic,bridge,"bridge:name",tunnel,"tunnel:name",electrified,electrified:rail,::voltage,incline,::ele,start_date,end_date,operator
